...
class Plant(models.Model):
    ...
    product_description = models.TextField(default="Not Available")
    family = models.CharField(max_length=100, default="Not Available")
    origin = models.CharField(max_length=100, default="Not Available")
    environment = models.TextField(default="Not Available")
    landscape_use = models.TextField(default="Not Available")
